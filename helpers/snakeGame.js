...
const { disableButtons } = require('./snake')
...
module.exports = class SnakeGame {
    constructor(options = {}) {
        ...
        if (!options.embed.color) options.embed.color = '#36393F';
    ...
    async gameOver(msg) {
        ...
        this.isInGame = false;
        const text = ':skull: **|** ' + this.options.embed.overTitle + '\ kalıcı olarak skorun: `' + this.score.toString() + '`';
